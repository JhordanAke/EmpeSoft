...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-lg"><b><h4>{{Session::get('nombre')}}</h4></b></span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('mutu')}}">Mutuarios</a></li>
            <li><a href="{{url('empe')}}">Empeños</a></li>
            <li><a href="{{url('cate2')}}">Categorias</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
