...
<div id="Empeños">
	<div class="container">
		...
		<select class="form-control" v-model="id_mutuario" @change="getEmpeños">
			...
			<div class="col-xs-4">
				<button class="btn btn-primary glyphicon glyphicon-refresh btn-block" 
				v-on:click="updateEmpeño(auxEmpeño)" v-if="editando"> Actualizar</button><br><br>

				<button class="btn btn-danger glyphicon glyphicon-remove btn-block" 
				v-on:click="cancelarEdit()"> Cancelar</button><br><br>

				<button class="btn btn-success glyphicon glyphicon-plus btn-block" 
		...
		<table class="table table-bordered table-hover" style="background-color: lightgreen">
			...
			<tbody>
				<tr v-for="emp in filtroEmpeños" class="teb">
					...
					<td width="10%">
						<span class="btn btn-primary btn-xs glyphicon glyphicon-pencil" 
